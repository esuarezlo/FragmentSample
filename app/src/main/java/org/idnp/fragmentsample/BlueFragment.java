 ...
 */
public class BlueFragment extends Fragment implements FragmentCallbacks {

    private static final String TAG = "BlueFragment";
    private MainCallbacks mainCallbacks;
    private TextView txtBlueMessage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtBlueMessage= view.findViewById(R.id.txtBlueMessage);
    ...
    public void onMsgFromMainToFragment(String strValue) {
        Log.d(TAG, strValue);
        txtBlueMessage.append(strValue);
    }
}